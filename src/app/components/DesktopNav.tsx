...
export default function DesktopNav() {
  return (
    <div className="*:text-white hidden md:block w-56 bg-white px-4 py-6 shadow-md shadow-gray-300 dark:bg-gray-800 dark:shadow-gray-700">
      <div className="sticky top-4">
        {/* <img
          className="mb-8 w-28 dark:invert"
