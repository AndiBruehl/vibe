...
export default async function AdminPage({ searchParams }: { searchParams: Promise<{ tab?: string }> }) {
  ...
  const [reports, notes, profiles, auditEntries, supportTickets, polls] = await Promise.all([
    ...
    prisma.profile.findMany({ select: { id: true, email: true, name: true, username: true, isAdmin: true, isVerified: true, isSystem: true, restrictedUntil: true, restrictionMessages: true, restrictionComments: true, restrictionPosts: true }, orderBy: { name: "asc" } }),
