      ...
      {profiles.map(profile => {
        const content = <>
          ...
          <div className="min-w-0">
            <h2 className="flex flex-wrap items-center gap-2 break-words font-semibold text-slate-900 dark:text-white">{profile.name || profile.username || (de ? "Unbenanntes Profil" : "Unnamed profile")}<AdminBadge isAdmin={profile.isAdmin} isVerified={profile.isVerified} badges={profile.profileBadges} hiddenBadges={profile.hiddenProfileBadges} /></h2>
