...
export default function EditProfileScreen() {
  ...
  return <Screen><KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : undefined}><ScrollView contentContainerStyle={{ paddingVertical: 16, gap: 12 }} keyboardShouldPersistTaps="handled">
    ...
    <Text style={{ color: colors.text, fontWeight: "700" }}>Username</Text><TextInput value={username} onChangeText={setUsername} autoCapitalize="none" autoCorrect={false} maxLength={80} style={input} placeholder="your_username" placeholderTextColor={colors.muted} />
